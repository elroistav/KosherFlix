...
public class MovieEditDialog extends Dialog {
    ...
    public interface OnMovieSaveListener {
        void onMovieSave(MovieModel updatedMovie, Uri thumbnailUri, Uri videoUri, ArrayList<String> categories);
    }

    public MovieEditDialog(@NonNull Context context, MovieModel movie, OnMovieSaveListener saveListener) {
        super(context);
    ...
    private void validateAndSave() {
        ...
        try {
            ...
            MovieModel updatedMovie = createMovieModel(
                    title,
            ...
            if (saveListener != null) {
                saveListener.onMovieSave(updatedMovie, selectedImageUri, selectedVideoUri, selectedCategories);
            }
    ...
    private MovieModel createMovieModel(String title, String description,
        ...
        try {
            ...
            parcel.writeString("");  // Thumbnail placeholder
            parcel.writeString("");  // Video URL placeholder
    ...
    public void handleSaveResult(boolean success, String errorMessage) {
        new Handler(Looper.getMainLooper()).post(() -> {
            ...
            if (success) {
                ...
                showError(errorMessage != null ? errorMessage : "Failed to update movie");
            }
        });
    }
}